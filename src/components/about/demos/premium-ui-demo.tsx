  ...
  return (
    ...
    >
      <video
        ...
        poster="/about/premium-ui-poster.jpg"
        ...
        className="aspect-square w-full object-cover [transform:translateZ(0)]"
      >
        {shouldLoad ? (
          <>
            <source src="/about/premium-ui.webm" type="video/webm" />
            <source src="/about/premium-ui.mp4" type="video/mp4" />
          </>
        ) : null}
      </video>
    </div>
