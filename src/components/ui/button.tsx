...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-foreground text-background shadow-soft hover:bg-foreground/90 hover:shadow-premium",
        accent:
          "bg-accent text-white shadow-soft hover:bg-accent/90 hover:shadow-premium",
        outline:
          "border border-border bg-background hover:bg-secondary hover:border-foreground/20",
        ghost: "hover:bg-secondary",
        glass:
          "glass text-foreground hover:bg-white/90 shadow-soft",
